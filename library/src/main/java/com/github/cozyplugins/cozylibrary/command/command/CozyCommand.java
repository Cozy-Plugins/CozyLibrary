...
public interface CozyCommand {
     ...
     */
    @Nullable
    PermissionPool getPermissionPool();
     ...
     */
    @Nullable
    CommandSuggestions getSuggestions(@NotNull User user, @NotNull CommandArguments arguments);
     ...
     */
    @Nullable
    CommandStatus onUser(@NotNull User user, @NotNull CommandArguments arguments);
     ...
     */
    @Nullable
    CommandStatus onPlayerUser(@NotNull PlayerUser user, @NotNull CommandArguments arguments, @NotNull CommandStatus status);
     ...
     */
    @Nullable
    CommandStatus onFakeUser(@NotNull FakeUser user, @NotNull CommandArguments arguments, @NotNull CommandStatus status);
     ...
     */
    @Nullable
    CommandStatus onConsoleUser(@NotNull ConsoleUser user, @NotNull CommandArguments arguments, @NotNull CommandStatus status);
}
